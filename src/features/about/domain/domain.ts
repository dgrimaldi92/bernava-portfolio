const data: string[] = [
	...
	"The research invites us to care for things through a continuous re-reading in a contemporary key: not by altering their spirit, but by revealing their specific beauty through the symbolism of color.",
];
